...
const BGM = (() => {
  let ctx = null,
    ...
    nodes = [],
    timer = null;
  const mel = [[523, .3], [587, .3], [659, .3], [523, .3], [523, .3], [587, .3], [659, .3], [523, .3], [659, .3], [698, .3], [784, .6], [659, .3], [698, .3], [784, .6], [784, .15], [880, .15], [784, .15], [698, .15], [659, .3], [523, .3], [784, .15], [880, .15], [784, .15], [698, .15], [659, .3], [523, .3], [523, .3], [392, .3], [523, .6], [523, .3], [392, .3], [523, .6]];
  const bas = [[262, .6], [262, .6], [262, .6], [262, .6], [330, .6], [349, .6], [392, 1.2], [349, .6], [330, .6], [262, .6], [262, .6], [349, .6], [330, .6], [262, .6], [262, .6], [262, .6], [196, .6], [262, 1.2], [262, .6], [196, .6], [262, 1.2]];
  const loop = () => {
    if (!playing) return;
    try {
      if (!ctx) ctx = new (window.AudioContext || window.webkitAudioContext)();
      ...
      mel.forEach(([f, d]) => {
        ...
        g.gain.exponentialRampToValueAtTime(0.001, t + off + d * 0.95);
      ...
      bas.forEach(([f, d]) => {
        ...
        g.gain.setValueAtTime(0.04, t + bo);
        g.gain.exponentialRampToValueAtTime(0.001, t + bo + d * 0.9);
        o.connect(g).connect(ctx.destination);
        o.start(t + bo);
        o.stop(t + bo + d);
        nodes.push(o);
...
// 隠しステージ EX1-5（ステージ10クリア後に解放）
{
  ...
  ex: true,
  hl: 6,
  intro: "🧑‍🔬博士「バブリンが…進化しておる！手札6枚の制限付きじゃ！」",
  ...
  hl: 6,
  deckSize: 40,
  intro: "🧑‍🔬博士「最後の敵は…な、なんじゃこれは！？正体不明のモンスターじゃ！手札6枚＋山札少なめの最凶ハンデ！」",
...
const Orbs = ({
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    style: {
      ...
      background: co,
      filter: "blur(40px)",
      animation: "bo ".concat(v.d, "s ").concat(v.dl, "s ease-in-out infinite")
    }
  })));
};
const BgmBtn = () => {
  ...
  return /*#__PURE__*/React.createElement("button", {
    ...
    style: {
      ...
      background: on ? "rgba(102,255,102,.12)" : "rgba(255,255,255,.06)",
      color: on ? "#66ff66" : "rgba(255,255,255,.4)",
      fontSize: 11,
      fontWeight: 700,
      cursor: "pointer",
      whiteSpace: "nowrap"
...
const SBtn = ({
  ...
  style: {
    padding: "8px 12px",
    borderRadius: 12,
    border: "2px solid ".concat(a ? co : "rgba(255,255,255,.1)"),
    background: a ? "".concat(co, "18") : "rgba(255,255,255,.04)",
    color: a ? co : "rgba(255,255,255,.4)",
    fontSize: 13,
    fontWeight: 900,
    cursor: "pointer"
  }
...
const Card = ({
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    style: {
      ...
      height: 92,
      borderRadius: 16,
      background: sel ? "linear-gradient(145deg,".concat(i.c, ",").concat(i.tc, "22)") : "linear-gradient(145deg,#1a1a2e,#16213e)",
      border: sel ? "3px solid ".concat(i.g) : "2px solid rgba(255,255,255,.08)",
      display: "flex",
      flexDirection: "column",
      alignItems: "center",
      justifyContent: "center",
      boxShadow: sel ? "0 0 16px ".concat(i.g, "66") : "0 2px 8px rgba(0,0,0,.3)",
      cursor: onTap ? "pointer" : "default",
      transition: "all .2s cubic-bezier(.34,1.56,.64,1)",
      flexShrink: 0,
      transform: sel ? "translateY(-8px) scale(1.08)" : "none",
      gap: 1,
      "--g": i.g,
      animation: sel ? "pg 1.5s ease-in-out infinite" : "ca .3s ".concat(dl, "s ease both")
    }
    ...
    style: {
      fontSize: 9,
      color: sel ? i.tc : "rgba(255,255,255,.5)",
      fontWeight: 700
    }
  }, t(card.k)));
};
const Badge = ({
  ...
  return /*#__PURE__*/React.createElement("div", {
    style: {
      ...
      borderRadius: 10,
      padding: "4px 10px",
      border: comp.sp ? "2px solid #CE93D8" : "1px solid rgba(255,255,255,.1)"
    }
  }, /*#__PURE__*/React.createElement("span", {
    style: {
      fontSize: 14
    ...
    style: {
      fontSize: 11,
      fontWeight: 800,
      color: comp.sp ? "#e1bee7" : "#ffcc00",
      background: comp.sp ? "rgba(156,39,176,.3)" : "rgba(255,152,0,.2)",
      borderRadius: 6,
      padding: "1px 6px"
    }
  }, comp.p, t("pt")));
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    return /*#__PURE__*/React.createElement("div", {
      ...
      style: {
        ...
        bottom: 0,
        width: "100%",
        height: "".concat(Math.max(0, rem / at.n * 100), "%"),
        background: "linear-gradient(180deg,".concat(at.g, "88,").concat(at.g, "33)"),
        borderRadius: 3,
      ...
      style: {
        fontSize: 10,
        fontWeight: 800,
        color: rem > at.n * .5 ? "#66ff66" : rem > 0 ? "#ffcc00" : "#ff4444"
      }
    }, rem));
  })), /*#__PURE__*/React.createElement("div", {
    style: {
...
const Celeb = ({
  ...
  const tier = pts >= 15 ? 3 : pts >= 9 ? 2 : pts >= 5 ? 1 : 0;
  const mc = ["#66ff66", "#ffcc00", "#ff6633", "#cc66ff"][tier];
  const bg = ["rgba(20,40,20,.95)", "rgba(40,30,10,.95)", "rgba(50,15,5,.95)", "rgba(25,5,45,.95)"][tier];
  useEffect(() => {
    if (tier >= 2) {
      SE.tap();
  ...
  const spinS = useRef(tier >= 2 ? Array.from({
    ...
    dl: Math.random() * .6,
    co: ["#FFD54F", "#FF8A65", "#CE93D8", "#81D4FA", "#A5D6A7", "#ff4444"][i % 6]
  })) : []).current;
  ...
  return /*#__PURE__*/React.createElement("div", {
    style: {
      ...
      transition: "background ".concat(tier >= 2 ? '.5s' : '.3s'),
      overflow: "hidden"
    }
    ...
    style: {
      ...
      borderRadius: "50%",
      background: "radial-gradient(circle,".concat(mc, "44,").concat(mc, "11,transparent)"),
      "--cg": "".concat(mc, "66"),
      animation: "charge ".concat(tier >= 3 ? '1.8s' : '1s', " ease both, chargeGlow .4s ease-in-out infinite"),
      zIndex: 2
    }
    ...
    return /*#__PURE__*/React.createElement("div", {
      ...
      style: {
        ...
        borderRadius: "50%",
        background: mc,
        left: "calc(50% + ".concat(Math.cos(a) * 150, "px)"),
        top: "calc(50% + ".concat(Math.sin(a) * 150, "px)"),
        animation: "charge 1.5s ".concat(i * .08, "s ease both"),
        zIndex: 3
      }
    });
    ...
    style: {
      ...
      height: 100,
      borderRadius: "50%",
      border: "4px solid ".concat(mc),
      animation: "ringBurst .8s ".concat(dl, "s ease-out forwards"),
      opacity: 0,
      zIndex: 4
    }
    ...
    style: {
      ...
      "--dx": "".concat(p.x, "px"),
      "--dy": "".concat(p.y, "px"),
      animation: "ke ".concat(.6 + tier * .3, "s ").concat(p.dl, "s cubic-bezier(.2,.6,.3,1) forwards"),
      opacity: 0,
      zIndex: 5
    }
    ...
    style: {
      ...
      borderRadius: "50%",
      background: s.co,
      boxShadow: "0 0 ".concat(s.sz, "px ").concat(s.co),
      animation: "starSpin 1s ".concat(s.dl, "s ease-out forwards"),
      opacity: 0,
      zIndex: 5,
      left: "calc(50% + ".concat(Math.cos(s.ang * Math.PI / 180) * s.dist, "px)"),
      top: "calc(50% + ".concat(Math.sin(s.ang * Math.PI / 180) * s.dist, "px)")
    }
  })), /*#__PURE__*/React.createElement("div", {
    style: {
      textAlign: "center",
      zIndex: 10,
      animation: tier >= 3 && ph >= 2 ? "ks .5s .1s ease both" : "none"
    }
  }, ph === 1 && tier >= 2 && /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: 20,
      ...
      color: mc,
      opacity: .8,
      animation: "kt .3s ease-in-out infinite"
    }
  }, tier >= 3 ? "・・・！！！" : "・・・！"), ph >= 2 && /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: tier >= 3 ? 90 : tier >= 2 ? 72 : tier >= 1 ? 56 : 48,
      animation: tier >= 2 ? "megaBounce .6s cubic-bezier(.34,1.56,.64,1) both" : "kb .5s .1s cubic-bezier(.34,1.56,.64,1) both",
      opacity: 0,
      filter: tier >= 2 ? "drop-shadow(0 0 30px ".concat(mc, "88)") : "none"
    }
  }, comp.e), ph >= 2 && /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: tier >= 3 ? 72 : tier >= 2 ? 56 : tier >= 1 ? 44 : 36,
      fontWeight: 900,
      lineHeight: 1.1,
      color: mc,
      textShadow: tier >= 2 ? "0 0 40px ".concat(mc, "88,0 0 80px ").concat(mc, "44") : "0 0 20px ".concat(mc, "66"),
      animation: tier >= 2 ? "textReveal .5s .15s ease both" : "kb .5s .2s cubic-bezier(.34,1.56,.64,1) both",
      opacity: 0
    }
  ...
  }, t("pt"))), ph >= 3 && /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: tier >= 2 ? 28 : tier >= 1 ? 22 : 18,
      fontWeight: 800,
      color: "#fff",
      marginTop: 8,
      opacity: 0,
      animation: "ku .3s ease forwards",
      textShadow: tier >= 2 ? "0 0 16px ".concat(mc, "44") : "none"
    }
  }, t(comp.k)), ph >= 3 && /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: 16,
      color: "rgba(255,255,255,.5)",
      marginTop: 2,
      opacity: 0,
      animation: "ku .3s .08s ease forwards"
    }
  }, comp.f), ph >= 4 && tier >= 1 && /*#__PURE__*/React.createElement("div", {
    style: {
      marginTop: 16,
      display: "inline-block",
      padding: tier >= 3 ? "10px 28px" : "6px 20px",
      borderRadius: 24,
      background: tier >= 3 ? "linear-gradient(135deg,#CE93D8,#FFD54F,#81D4FA,#CE93D8)" : tier >= 2 ? "linear-gradient(135deg,#FF8A65,#FFD54F)" : "linear-gradient(135deg,#66BB6A,#A5D6A7)",
      fontSize: tier >= 3 ? 18 : 15,
      fontWeight: 900,
      color: "#111",
      opacity: 0,
      animation: "ku .3s ease forwards"
    }
  }, tier >= 3 ? pts >= 30 ? "💎👑 でんせつ！！！" : "🏆🔥 すごすぎ！！" : tier >= 2 ? "🔥 すごい！" : "⭐ いいね！")));
};
const CpuOv = ({
  name,
  action,
  ...
  return /*#__PURE__*/React.createElement("div", {
    style: {
      ...
      alignItems: "center",
      justifyContent: "center",
      background: ph >= 1 ? "rgba(10,30,10,.94)" : "rgba(0,0,0,0)",
...
function Title({
  ...
  const Stg = () => /*#__PURE__*/React.createElement("div", {
    ...
    key: n,
    l: "".concat(n).concat(t("mai")).concat(n === 7 ? "\uFF08".concat(t("basic"), "\uFF09") : ""),
    a: hl === n,
    onClick: () => setHL(n)
  }))), /*#__PURE__*/React.createElement("div", {
    style: {
  ...
  const PremPanel = () => /*#__PURE__*/React.createElement("div", {
    style: {
      ...
      padding: 16,
      borderRadius: 16,
      background: premium ? "rgba(102,255,102,.04)" : "linear-gradient(135deg,rgba(255,204,0,.06),rgba(255,112,67,.06))",
      border: premium ? "1px solid rgba(102,255,102,.2)" : "2px solid rgba(255,204,0,.2)",
      maxWidth: 300,
      width: "100%"
    }
  }, /*#__PURE__*/React.createElement("div", {
  ...
  }, t("locked"), " ", t(c.k)))), /*#__PURE__*/React.createElement("button", {
    onClick: () => {
      SE.gStart();
      setPremium(true);
    },
    style: {
      ...
      fontWeight: 900,
      cursor: "pointer",
      boxShadow: "0 4px 16px rgba(255,152,0,.3)"
    }
  ...
  }, /*#__PURE__*/React.createElement(Orbs, null), /*#__PURE__*/React.createElement(BgmBtn, null), /*#__PURE__*/React.createElement("div", {
    style: {
      position: "relative",
      zIndex: 1,
      display: "flex",
  ...
  if (mode === null) return wrap(/*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("div", {
    style: {
      ...
      filter: "drop-shadow(0 4px 20px rgba(124,77,255,.4))"
    }
  ...
  }, t("title2")), /*#__PURE__*/React.createElement("button", {
    onClick: () => {
      setMode("cpu");
      SE.tap();
    },
    style: {
      ...
      fontWeight: 900,
      cursor: "pointer",
      boxShadow: "0 4px 30px rgba(255,87,34,.4)",
      marginBottom: 14,
      display: "flex",
      alignItems: "center",
      justifyContent: "center",
  ...
  }, "\uD83E\uDD16"), /*#__PURE__*/React.createElement("span", null, t("solo"), /*#__PURE__*/React.createElement("br", null), /*#__PURE__*/React.createElement("span", {
    style: {
      fontSize: 12,
      fontWeight: 600,
      opacity: .9
    }
  }, t("soloSub")))), /*#__PURE__*/React.createElement("button", {
    onClick: () => {
      setMode("story");
      SE.tap();
    },
    style: {
      ...
      fontWeight: 900,
      cursor: "pointer",
      boxShadow: "0 4px 30px rgba(233,30,99,.4)",
      marginBottom: 14,
      display: "flex",
      alignItems: "center",
      justifyContent: "center",
  ...
  }, "\u2694\uFE0F"), /*#__PURE__*/React.createElement("span", null, t("story"), /*#__PURE__*/React.createElement("br", null), /*#__PURE__*/React.createElement("span", {
    style: {
      fontSize: 12,
      fontWeight: 600,
      opacity: .9
    }
  }, t("storySub")))), /*#__PURE__*/React.createElement("button", {
    onClick: () => {
      setMode("multi");
      SE.tap();
    },
    style: {
      ...
      fontWeight: 900,
      cursor: "pointer",
      boxShadow: "0 4px 30px rgba(101,31,255,.4)",
      display: "flex",
      alignItems: "center",
      justifyContent: "center",
      gap: 10
  ...
  }, "\uD83D\uDC6B"), /*#__PURE__*/React.createElement("span", null, t("multi"), /*#__PURE__*/React.createElement("br", null), /*#__PURE__*/React.createElement("span", {
    style: {
      fontSize: 12,
      fontWeight: 600,
      opacity: .9
    }
  }, t("multiSub")))), /*#__PURE__*/React.createElement(Stg, null), /*#__PURE__*/React.createElement("div", {
    style: {
      marginTop: 12,
      padding: 16,
      borderRadius: 16,
  ...
  }, "\u2460 ", t("r1"), /*#__PURE__*/React.createElement("br", null), "\u2461 ", t("r2"), /*#__PURE__*/React.createElement("br", null), "\u2462 ", t("r3"), /*#__PURE__*/React.createElement("br", null), "\u2463 ", t("hand"), hl, t("r4"), /*#__PURE__*/React.createElement("br", null), "\u2464 ", t("r5"), /*#__PURE__*/React.createElement("br", null), t("r6"), /*#__PURE__*/React.createElement("br", null), t("r7")))));
  ...
  if (mode === "story") {
    if (storySt === null) {
      ...
      return wrap(/*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("div", {
        ...
        return /*#__PURE__*/React.createElement("button", {
          ...
          style: {
            padding: "16px",
            borderRadius: 18,
            border: "2px solid ".concat(unlocked ? s.color + '66' : 'rgba(255,255,255,.08)'),
            background: unlocked ? "".concat(s.color, "0a") : 'rgba(255,255,255,.02)',
            color: "#fff",
        ...
        }, unlocked ? s.emoji : "🔒"), /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("div", {
          style: {
            fontSize: 12,
            color: s.color,
            fontWeight: 700
          }
        }, t("storyStage"), " ", s.id), /*#__PURE__*/React.createElement("div", {
          style: {
            fontSize: 16,
            fontWeight: 900
          }
        }, s.name))), cleared.has(s.id) && /*#__PURE__*/React.createElement("span", {
          style: {
            fontSize: 12,
            color: "#66ff66",
            fontWeight: 700,
        ...
        style: {
          marginTop: 16,
          padding: "10px 0",
          borderTop: "2px solid rgba(255,23,68,.3)",
          textAlign: "center"
        }
      }, /*#__PURE__*/React.createElement("span", {
        style: {
      ...
      }, "\uD83C\uDF1F \u96A0\u3057\u30B9\u30C6\u30FC\u30B8\u89E3\u653E\uFF01")), exStages.map((s, i) => {
        const prevEx = i === 0 ? 10 : exStages[i - 1].id;
        const unlocked = cleared.has(prevEx);
        return /*#__PURE__*/React.createElement("button", {
          key: s.id,
          onClick: () => {
            if (unlocked) {
        ...
        }, "EX ", s.id - 10), /*#__PURE__*/React.createElement("div", {
          style: {
            fontSize: 16,
            fontWeight: 900
          }
        }, unlocked ? s.name : "???"), unlocked && s.hl && /*#__PURE__*/React.createElement("div", {
          style: {
            fontSize: 10,
            color: "#ff4444"
          }
        }, "\u26A0\uFE0F \u624B\u672D", s.hl, "\u679A"), unlocked && s.deckSize && /*#__PURE__*/React.createElement("div", {
          style: {
            fontSize: 10,
            color: "#ff4444"
          }
        }, "\u26A0\uFE0F \u5C71\u672D", s.deckSize, "\u679A"))), cleared.has(s.id) && /*#__PURE__*/React.createElement("span", {
          style: {
            fontSize: 12,
            color: "#66ff66",
            fontWeight: 700,
      ...
      })), !allMainCleared && /*#__PURE__*/React.createElement("div", {
        style: {
          marginTop: 12,
          textAlign: "center",
          fontSize: 13,
      ...
      }, " \u30B9\u30C6\u30FC\u30B810\u30AF\u30EA\u30A2\u3067\u96A0\u3057\u30B9\u30C6\u30FC\u30B8\u89E3\u653E\uFF01")), /*#__PURE__*/React.createElement("button", {
        onClick: () => setMode(null),
        style: {
          marginTop: 20,
          padding: "10px 24px",
      ...
      return wrap(/*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("div", {
        style: {
          ...
          filter: "drop-shadow(0 8px 30px ".concat(s.color, "66)")
        }
      ...
      }, t("storyStage"), " ", s.id), /*#__PURE__*/React.createElement("h2", {
        style: {
          fontSize: 26,
          fontWeight: 900,
          color: "#fff",
      ...
      }, s.intro), /*#__PURE__*/React.createElement("button", {
        onClick: () => {
          SE.gStart();
          onStartStory(s);
        },
        style: {
          ...
          borderRadius: 20,
          border: "none",
          background: "linear-gradient(135deg,".concat(s.color, ",").concat(s.color, "88)"),
          color: "#fff",
          fontSize: 20,
          fontWeight: 900,
          cursor: "pointer",
          boxShadow: "0 4px 30px ".concat(s.color, "44")
        }
  ...
  return wrap(/*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("div", {
    ...
    placeholder: "".concat(i + 1).concat(t("pn")),
    style: {
      width: "100%",
      padding: "12px 16px",
      borderRadius: 14,
    ...
    onClick: () => {
      SE.gStart();
      onStart(names.slice(0, pc).map((n, i) => n.trim() || "".concat(i + 1, "\u3070\u3093")), hl);
    },
    style: {
      padding: "16px 48px",
      borderRadius: 20,
  ...
  }, "\uD83C\uDFAE ", t("gstart")), /*#__PURE__*/React.createElement("button", {
    onClick: () => setMode(null),
    style: {
      marginTop: 14,
      padding: "10px 24px",
...
const Pass = ({
  ...
  return /*#__PURE__*/React.createElement("div", {
    style: {
      ...
      justifyContent: "center",
      padding: "calc(24px + env(safe-area-inset-top)) 24px 24px 24px",
      background: "radial-gradient(ellipse at 50% 50%,rgba(124,77,255,.1) 0%,transparent 60%),linear-gradient(180deg,#0a0a1a,#0f1628)"
    }
  }, /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: 56,
...
function Game({
  ...
  const pl = state.pl[pi],
    hand = pl.hand;
  const PLCOLORS = [{
    bg: "linear-gradient(180deg,#0a0a1a,#0a1628)",
    accent: "#b388ff",
    headerBg: "rgba(124,77,255,.06)",
    border: "rgba(124,77,255,.15)"
  }, {
    bg: "linear-gradient(180deg,#0a1a0a,#0a2810)",
    accent: "#66ff66",
    headerBg: "rgba(102,255,102,.06)",
    border: "rgba(102,255,102,.15)"
  }, {
    bg: "linear-gradient(180deg,#1a0a0a,#281010)",
    accent: "#ff8a65",
    headerBg: "rgba(255,138,101,.06)",
    border: "rgba(255,138,101,.15)"
  }, {
    bg: "linear-gradient(180deg,#1a1a0a,#282010)",
    accent: "#ffcc00",
    headerBg: "rgba(255,204,0,.06)",
    border: "rgba(255,204,0,.15)"
  }];
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    style: {
      ...
      borderBottom: "1px solid ".concat(pco.border)
    }
  }, /*#__PURE__*/React.createElement("div", {
    style: {
      display: "flex",
    ...
    style: {
      fontSize: 18,
      fontWeight: 900,
      color: state.deck.length > 20 ? "#b388ff" : "#ff4444"
    }
    ...
    style: {
      padding: "12px 16px",
      textAlign: "center",
      background: "rgba(102,255,102,.08)"
    }
  }, /*#__PURE__*/React.createElement("span", {
    style: {
      fontSize: 14,
    ...
    return /*#__PURE__*/React.createElement("div", {
      ...
      return /*#__PURE__*/React.createElement("div", {
        ...
        style: {
          ...
          alignItems: "center",
          justifyContent: "center",
          boxShadow: "0 2px 8px rgba(255,68,68,.5)",
          lineHeight: 1,
          zIndex: 2
        }
      }, "\xD7"));
    ...
    style: {
      ...
      border: "2px solid rgba(102,255,102,.2)",
      textAlign: "center",
      animation: "su .3s ease"
    }
  }, /*#__PURE__*/React.createElement("div", {
  ...
  }, "\uD83D\uDC8E ", t("sp")), /*#__PURE__*/React.createElement("button", {
    onClick: doBond,
    style: {
      marginTop: 10,
      padding: "12px 36px",
    ...
    style: {
      ...
      marginBottom: 6,
      borderRadius: 10,
      background: "rgba(102,255,102,.05)",
      border: c.sp ? "2px solid #CE93D8" : "1px solid rgba(102,255,102,.15)"
    }
  }, /*#__PURE__*/React.createElement("div", {
    style: {
      display: "flex",
    ...
    return Array.from({
      ...
      key: "".concat(s).concat(j),
      style: {
        width: 32,
        height: 38,
        borderRadius: 7,
        background: "rgba(255,255,255,.06)",
        border: "2px solid ".concat(inf.g, "44"),
        display: "flex",
        flexDirection: "column",
        alignItems: "center",
        justifyContent: "center"
    ...
    return /*#__PURE__*/React.createElement("div", {
      ...
      style: {
        ...
        marginBottom: 6,
        borderRadius: 10,
        background: isLocked ? "rgba(255,255,255,.01)" : "rgba(255,255,255,.02)",
        border: c.sp ? "2px solid #CE93D8" : isLocked ? "1px solid rgba(255,255,255,.03)" : "1px solid rgba(255,255,255,.05)",
      ...
      style: {
        fontSize: 13,
        color: isLocked ? "rgba(255,255,255,.3)" : "rgba(255,255,255,.6)",
        fontWeight: 700
      }
      ...
      style: {
        fontSize: 14,
        fontWeight: 900,
        color: isLocked ? "rgba(255,255,255,.3)" : "#111",
        background: isLocked ? "rgba(255,255,255,.08)" : c.sp ? "#CE93D8" : c.p >= 15 ? "#ff6633" : c.p >= 9 ? "#ffcc00" : c.p >= 5 ? "#ff9800" : "#66ff66",
        borderRadius: 8,
        padding: "2px 8px",
        minWidth: 40,
        textAlign: "center"
      ...
      return Array.from({
        ...
        style: {
          ...
          height: 38,
          borderRadius: 7,
          background: isLocked ? "rgba(255,255,255,.02)" : "rgba(255,255,255,.04)",
          border: "2px solid ".concat(isLocked ? 'rgba(255,255,255,.06)' : inf.g + '33'),
          display: "flex",
          flexDirection: "column",
          alignItems: "center",
          justifyContent: "center"
        ...
        style: {
          fontSize: 11,
          fontWeight: 900,
          color: isLocked ? "rgba(255,255,255,.2)" : inf.g
        }
      }, s)));
    }), /*#__PURE__*/React.createElement("span", {
      style: {
      ...
      style: {
        fontSize: 12,
        color: isLocked ? "rgba(255,255,255,.2)" : "rgba(255,255,255,.4)",
        fontWeight: 600
      }
    }, c.f)));
  }))), /*#__PURE__*/React.createElement("div", {
    ...
    style: {
      padding: "8px 14px",
      borderRadius: 12,
      background: i === pi ? "rgba(124,77,255,.12)" : "rgba(255,255,255,.03)",
      border: i === pi ? "2px solid rgba(179,136,255,.4)" : "1px solid rgba(255,255,255,.06)"
    }
  }, /*#__PURE__*/React.createElement("span", {
    style: {
      fontSize: 13,
      color: i === pi ? "#b388ff" : "rgba(255,255,255,.4)",
      fontWeight: 700
    }
  ...
  }, !drew && !bonded ? state.deck.length > 0 ? /*#__PURE__*/React.createElement("button", {
    onClick: doDraw,
    disabled: !!cel,
    style: {
      flex: 1,
      ...
      fontSize: 18,
      fontWeight: 900,
      cursor: cel ? "default" : "pointer",
      boxShadow: "0 4px 20px rgba(101,31,255,.4)"
    }
  }, t("drB")) : /*#__PURE__*/React.createElement("button", {
    onClick: onFinish,
    style: {
      flex: 1,
      padding: 16,
      ...
      fontWeight: 900,
      cursor: "pointer",
      boxShadow: "0 4px 20px rgba(255,87,34,.4)",
...
function Result({
  ...
  useEffect(() => {
    ...
    // ストーリーモードで勝った場合、クリア処理
    if (storyStage && playerWon && onStoryWin) {
      setTimeout(() => onStoryWin(), 100);
    }
    return () => {
  ...
  const conf = useRef(Array.from({
    ...
    dl: Math.random() * 3,
    dur: 2 + Math.random() * 3,
    co: ["#ff4444", "#ffcc00", "#66ff66", "#448aff", "#b388ff", "#ff9800", "#00e5ff", "#CE93D8"][i % 8],
    sz: 6 + Math.random() * 8
  }))).current;
  const fws = useRef(Array.from({
    ...
    co: ["#ff4444", "#ffcc00", "#66ff66", "#b388ff", "#00e5ff", "#ff9800"][i % 6]
  }))).current;
  ...
  const bgWin = "radial-gradient(ellipse at 50% 30%,rgba(255,204,0,.1) 0%,transparent 50%),linear-gradient(180deg,#0a0a1a,#0f1628)";
  const bgLose = "radial-gradient(ellipse at 50% 30%,rgba(100,100,180,.08) 0%,transparent 50%),linear-gradient(180deg,#08081a,#0a0e20)";
  const bgTie = "radial-gradient(ellipse at 50% 30%,rgba(180,180,180,.08) 0%,transparent 50%),linear-gradient(180deg,#0a0a1a,#0f1628)";
  return /*#__PURE__*/React.createElement("div", {
    style: {
      minHeight: "100dvh",
      display: "flex",
      ...
      padding: 24,
      paddingTop: 20,
      background: playerLost ? bgLose : isDraw ? bgTie : bgWin,
      position: "relative",
      overflow: "hidden"
    }
  }, /*#__PURE__*/React.createElement(Orbs, {
    n: 10,
    co: playerLost ? "rgba(100,130,200,.04)" : "rgba(255,204,0,.04)"
  }), ph >= 1 && playerWon && conf.map(c => /*#__PURE__*/React.createElement("div", {
    key: c.id,
    style: {
      position: "fixed",
      left: "".concat(c.x, "%"),
      ...
      borderRadius: 2,
      opacity: 0,
      animation: "cf ".concat(c.dur, "s ").concat(c.dl, "s linear infinite"),
      zIndex: 5
    }
    ...
    style: {
      ...
      height: f.sz,
      borderRadius: "50%",
      border: "3px solid ".concat(f.co),
      opacity: 0,
      animation: "fw 1.2s ".concat(f.dl, "s ease-out infinite"),
      boxShadow: "0 0 20px ".concat(f.co),
      zIndex: 4
    }
    ...
    style: {
      ...
      width: r.sz,
      height: r.sz * 8,
      background: "linear-gradient(180deg,transparent,rgba(150,180,220,.4))",
      borderRadius: "0 0 2px 2px",
      opacity: 0,
      animation: "rain ".concat(r.dur, "s ").concat(r.dl, "s linear infinite"),
      zIndex: 5
    }
  })), /*#__PURE__*/React.createElement("div", {
    style: {
    ...
    style: {
      ...
      filter: "drop-shadow(0 8px 30px rgba(255,204,0,.5))",
      marginBottom: 8
    }
  }, "\uD83D\uDC51"), /*#__PURE__*/React.createElement("div", {
    style: {
    ...
    style: {
      fontSize: 64,
      fontWeight: 900,
      color: playerLost ? "rgba(150,180,220,.7)" : "#ffcc00",
      textShadow: playerLost ? "none" : "0 0 40px rgba(255,204,0,.5),0 0 80px rgba(255,204,0,.3)",
      textAlign: "center"
    }
    ...
    style: {
      ...
      marginTop: 4,
      fontSize: 16,
      color: playerLost ? "rgba(150,180,220,.5)" : "#ff9800",
      fontWeight: 800,
      animation: "su .4s .3s ease both",
      opacity: 0
    }
  }, playerLost ? "\uD83D\uDCC9 ".concat(diff).concat(t("pdif")) : "\uD83D\uDD25 ".concat(diff).concat(t("more")))), ph >= 3 && /*#__PURE__*/React.createElement("div", {
    style: {
      width: "100%",
      display: "flex",
      flexDirection: "column",
    ...
    style: {
      padding: 16,
      borderRadius: 18,
      background: r === 0 ? playerLost ? "rgba(100,130,200,.06)" : "rgba(255,204,0,.08)" : "rgba(255,255,255,.03)",
      border: r === 0 ? playerLost ? "2px solid rgba(100,130,200,.2)" : "2px solid rgba(255,204,0,.3)" : "1px solid rgba(255,255,255,.06)",
      boxShadow: r === 0 ? playerLost ? "0 4px 20px rgba(100,130,200,.1)" : "0 4px 30px rgba(255,204,0,.2)" : "none",
      animation: "su .4s ".concat(r * .15, "s ease both"),
      opacity: 0
    }
  }, /*#__PURE__*/React.createElement("div", {
    style: {
  ...
  }, med[r] || ""), /*#__PURE__*/React.createElement("span", {
    style: {
      fontSize: 20,
      fontWeight: 900,
      color: "#fff"
    ...
    style: {
      fontSize: 26,
      fontWeight: 900,
      color: r === 0 ? playerLost ? "rgba(150,180,220,.7)" : "#ffcc00" : "rgba(255,255,255,.6)",
      textShadow: r === 0 && !playerLost ? "0 0 16px rgba(255,204,0,.5)" : "none"
    }
  }, p.sc, /*#__PURE__*/React.createElement("span", {
    style: {
      fontSize: 14
    }
  }, t("pt")))), r > 0 && !isDraw && /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: 12,
      color: playerLost ? "rgba(150,180,220,.4)" : "#ff6633",
      fontWeight: 700,
      marginBottom: 6
    }
  }, "\uD83D\uDCCA ", t("pdif"), ": ", ranks[0].sc - p.sc, t("pt")), p.bonds.length > 0 ? /*#__PURE__*/React.createElement("div", {
    style: {
      display: "flex",
      flexWrap: "wrap",
      gap: 4
    }
  }, p.bonds.map((b, i) => /*#__PURE__*/React.createElement(Badge, {
    key: i,
    comp: b
  }))) : /*#__PURE__*/React.createElement("div", {
    style: {
  ...
  }, t("noB"))))), ph >= 4 && /*#__PURE__*/React.createElement(React.Fragment, null, storyStage && playerWon && /*#__PURE__*/React.createElement("div", {
    style: {
      marginTop: 16,
      padding: 16,
      borderRadius: 16,
      background: "".concat(storyStage.color, "11"),
      border: "2px solid ".concat(storyStage.color, "33"),
      maxWidth: 320,
      textAlign: "center",
    ...
    style: {
      fontSize: 14,
      color: storyStage.color,
      fontWeight: 700,
      lineHeight: 1.6
    }
  }, storyStage.win)), storyStage && playerLost && /*#__PURE__*/React.createElement("div", {
    style: {
      marginTop: 16,
      padding: 16,
      borderRadius: 16,
      background: "rgba(150,180,220,.05)",
      border: "1px solid rgba(150,180,220,.15)",
      maxWidth: 320,
      textAlign: "center",
      animation: "su .4s ease both"
    }
  ...
  }, storyStage.lose)), !storyStage && playerLost && /*#__PURE__*/React.createElement("div", {
    style: {
      marginTop: 16,
      fontSize: 16,
    ...
    onClick: onRestart,
    style: {
      marginTop: storyStage ? 16 : playerLost ? 12 : 28,
      padding: "16px 48px",
      borderRadius: 20,
      border: "none",
      background: playerLost ? "linear-gradient(135deg,#37474f,#546e7a)" : "linear-gradient(135deg,#651fff,#b388ff)",
      color: "#fff",
      fontSize: 20,
      fontWeight: 900,
      cursor: "pointer",
      boxShadow: playerLost ? "0 4px 20px rgba(55,71,79,.4)" : "0 4px 30px rgba(101,31,255,.4)",
      animation: "su .4s ease both"
    }
  }, storyStage ? "🗺️ ステージ選択へ" : t("again")))));
}
...
window.__App = function App() {
  ...
  const [premium, setPremium] = useState(true); // App Store公開時にfalseに戻す
  const [cleared, setCleared] = useState(new Set()); // ストーリークリア済みステージ
  const [storyStage, setStoryStage] = useState(null); // 現在のストーリーステージ

  // ゲーム中にブラウザの更新ボタンで戻るのを防止
  useEffect(() => {
    const handler = e => {
      if (scr === "game") {
        e.preventDefault();
  ...
  return /*#__PURE__*/React.createElement(LangCtx.Provider, {
    ...
    pn: gs.pl[cp].name,
    onReady: () => setSP(false),
    info: gs.deck.length > 0 ? "".concat(tx.dkRem, " ").concat(gs.deck.length, " ").concat(tx.mai) : tx.lastR
  }), scr === "game" && !cpuOv && !(sp && !isCpu) && gs && /*#__PURE__*/React.createElement(Game, {
    key: "".concat(cp, "-").concat(tc),
    state: gs,
    pi: cp,
    onDraw: draw,
    onBond: bond,
